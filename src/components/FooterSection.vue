    ...
    <div class="footer-section relative">
        <div class="newsletter sticky top-0 ">
            ...
            <p class="subheading">
                ...
                you’ll receive a few prompts and exercises designed to create your next breakthrough. No fluff, no filler,
                no BS. Just five minutes each week that could change your life.
            </p>
            <form class="newsletter-form">
                <input class="input-text" type="text" placeholder="Your Email Address">
                <div> <button class="submit-btn">Sign up</button></div>
            </form>
